# <div style="text-align: center">Kim-AssistantManagers-Day</div>
...
###### 이 프로젝트는 김대리라는 가상의 인물이 특정 시간동안 회사에서 주어지는 선택지를 따라가는 김대리의 인생게임입니다.</br>메소드를 호출하고 메세지를 출력하는 등 기본적인 자바의 기능을 이용하여 만든 작은 프로젝트입니다.
